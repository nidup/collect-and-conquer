...
export class TankAttackBrain extends VehicleBrain
{
    ...
    private explore = () =>
    {
        const visibleEnemy = this.host.getCamera().closestVisibleEnemy(this.host.getPosition().clone(), this.host.getVisibilityScope());
        if (visibleEnemy) {
            this.fsm.popState();
    ...
    private attackEnemy = () =>
    {
        const enemy = this.host.getCamera().closestVisibleEnemy(this.host.getPosition().clone(), this.host.getVisibilityScope());
        if (enemy !== null) {
